...
public abstract class InteractiveTileObject {
	...
	public InteractiveTileObject(PlayScreen screen, Rectangle bounds) {
		...
		bDef.position.set( (bounds.getX() + bounds.getWidth() / 2) / Recursos.PPM, (bounds.getY() + bounds.getHeight() / 2) / Recursos.PPM );
		
		body = world.createBody(bDef);
		
		shape.setAsBox( bounds.getWidth() / 2 / Recursos.PPM, bounds.getHeight() / 2 / Recursos.PPM);
		fDef.shape = shape;
